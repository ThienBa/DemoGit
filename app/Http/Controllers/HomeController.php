    ...
    function search_header(Request $request){
        if($request->has('search')){
            ...
            if($text){
                            ...
                            $output .= "<ul class='list-item clearfix'>";
                                    foreach ($result_post as &$item){
                                        ...
                                        $output .= "<li class='clearfix'>";
                                            $output .= "<a href='/IsMart/bai-viet/{$item->id}-{$slug}.html' title='' class='thumb fl-left'>
                                                <img src='/IsMart/public/{$item->thumbnail}' alt=''>
                                            </a>
                                            <div class='info fl-right'>
                                                <a href='/IsMart/bai-viet/{$item->id}-{$slug}.html' title='' class='title'>{$item->title}</a>
                ...
                return "<b>Hãy nhập từ khóa bạn muốn tìm kiếm cho sản phẩm và bài viết. Hoặc nhấn <a href='/IsMart/'>vào đây</a> để tiếp tục mua hàng.</b>";
            }
        }
    }
}
