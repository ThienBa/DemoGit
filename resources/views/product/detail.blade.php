                ...
                <div class="section-detail clearfix">
                    <div class="thumb-wp fl-left">
                        <a href="" title="" id="main-thumb">
                            <img id="zoom" width="350" src="{{asset($product->thumbnail)}}" data-zoom-image="{{asset($product->thumbnail)}}"/>
                        </a>
                        {{-- <div id="list-thumb">
                    ...
                    <div class="info fl-right">
                        ...
                        <div class="num-product">
                            ...
                            <span class="status">{{$product->qty > 0?"Còn hàng":"Hết hàng"}}</span>
                        </div>
                        ...
                        <a href="{{ url('them-gio-hang/'.$product->id.'-'.Str::slug($product->name)) }}" title="Thêm giỏ hàng" class="btn btn-success">Thêm giỏ hàng</a>
                    </div>
                </div>
            </div>
