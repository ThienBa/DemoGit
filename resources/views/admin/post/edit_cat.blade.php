...
<div id="content" class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ url('admin/post/cat/update', $cat->id) }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="level" id="level">
                        ...
                        <option {{$cat->level==1?"selected='selected'":""}} value="1">Cấp bậc 1</option>
                        <option {{$cat->level==2?"selected='selected'":""}} value="2">Cấp bậc 2</option>
                    </select>
                    @error('level')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
