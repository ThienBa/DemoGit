                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('admin/product/cat/add') }}">
                            ...
                            <button type="submit" class="btn btn-primary" value="Thêm mới" name="btn_add_product_cat">Thêm
                                mới</button>
                        </form>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($cats as $cat)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$cat->parent_id == 2?"--$cat->name":"$cat->name"}}</td>
                                        <td>{{$cat->parent_id}}</td>
                                        <td>{{$cat->creator}}</td>
                                        <td>{{$cat->status==1?"Chờ duyệt":"Đã đăng"}}</td>
                                        <td><a href="{{ url('admin/product/cat/edit', $cat->id) }}"
