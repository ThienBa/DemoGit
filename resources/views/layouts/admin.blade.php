...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="{{ url('dashboard') }}">ISMART ADMIN</a></div>
            <div class="nav-right ">
    ...
    <script src="https://cdn.tiny.cloud/1/5uaxdb2gbior5x2ivycvdlh3ty8j127snkcufae14v07s19f/tinymce/5/tinymce.min.js"
